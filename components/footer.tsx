    ...
    <footer className="border-t border-border bg-muted/30 mt-16">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="font-bold text-lg mb-4">MTY Tech Community</h3>
            <p className="text-foreground/70 text-sm">
              Connecting tech communities in Monterrey, fostering collaboration and growth.
            </p>
          </div>
          <div>
        ...
        <div className="border-t border-border pt-8 text-center text-sm text-foreground/60">
          ...
          <p className="mt-2">&copy; {currentYear} MTY Tech Community. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
